...
function(a) {
    ...
    $.fn.jqGrid = function(a) {
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                $(j).attr("id", "gview_" + this.id).appendTo(w),
                ...
                M = function(a, b, c, e) {
                    ...
                    d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) { - 1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b: 1 : (I.call(d, !1, !0), b = 1);
                        ...
                        d.p.userData = {},
                        d.p.page = z($.jgrid.getXmlData(a, i.page), d.p.page),
                        d.p.lastpage = z($.jgrid.getXmlData(a, i.total), 1),
                        d.p.records = z($.jgrid.getXmlData(a, i.records)),
                        ...
                        if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                            ...
                            for (d.p.grouping && (Y = d.p.groupingView.groupCollapse === !0, W = $.jgrid.getMethod("groupingPrepare")); Q > R;) {
                                ...
                                } else for (m = 0; m < C.length; m++) o = $.jgrid.getXmlData(t, C[m]),
                                J[d.p.colModel[m + y + A + B].name] = o,
                                K.push(D(u, o, m + y + A + B, R + b, t, J));
                                if (K[aa] = L(u, Y, v, J, t), K.push("</tr>"), d.p.grouping && (S.push(K), d.p.groupingView._locgr || W.call(w, J, R), K = []), (g || d.p.treeGrid === !0 && !d.p._ald) && (J[h] = $.jgrid.stripPref(d.p.idPrefix, u), d.p.data.push(J), d.p._index[J[h]] = d.p.data.length - 1), d.p.gridview === !1 && (V.append(K.join("")), w.triggerHandler("jqGridAfterInsertRow", [u, J, t]), X && d.p.afterInsertRow.call(d, u, J, t), K = []), J = {},
                                x++, R++, x === T) break
                            }
                        }
                ...
                N = function(a, b, c, e) {
                    var f = new Date;
                    if (a) { - 1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b: 1 : (I.call(d, !1, !0), b = 1);
                        var g, h, i = "_id_",
                        ...
                        d.p.page = z($.jgrid.getAccessor(a, g.page), d.p.page),
                        d.p.lastpage = z($.jgrid.getAccessor(a, g.total), 1),
                        d.p.records = z($.jgrid.getAccessor(a, g.records)),
                        d.p.userData = $.jgrid.getAccessor(a, g.userdata) || {},
                        K && (r = $.jgrid.getMethod("addSubGridCell")),
                        ...
                        for (d.p.grouping && (aa = d.p.groupingView.groupCollapse === !0, Y = $.jgrid.getMethod("groupingPrepare")); t > o;) {
                            ...
                            var fa = Q.length;
                            for (Q.push(""), M && Q.push(F(0, o, d.p.page, d.p.rowNum, ca)), J && Q.push(E(x, M, o, U, da)), K && Q.push(r.call(A, J + M, o + b)), s = O, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = N)), p = 0; p < s.length; p++) m = $.jgrid.getAccessor(q, s[p]),
                            P[d.p.colModel[p + J + K + M].name] = m,
                            Q.push(D(x, m, p + J + K + M, o + b, q, P));
                            if (y += U ? " " + n: "", Q[fa] = L(x, aa, y, P, q), Q.push("</tr>"), d.p.grouping && (_.push(Q), d.p.groupingView._locgr || Y.call(A, P, o), Q = []), (j || d.p.treeGrid === !0 && !d.p._ald) && (P[i] = $.jgrid.stripPref(d.p.idPrefix, x), d.p.data.push(P), d.p._index[P[i]] = d.p.data.length - 1), d.p.gridview === !1 && (ba.append(Q.join("")), A.triggerHandler("jqGridAfterInsertRow", [x, P, q]), Z && d.p.afterInsertRow.call(d, x, P, q), Q = []), P = {},
                            B++, o++, B === V) break
                        }
                ...
                O = function() {
                    ...
                    if ($.isArray(d.p.data)) {
                        ...
                        if (d.p.ignoreCase && (r = r.ignoreCase()), d.p.search === !0) {
                            ...
                            if (s)"string" == typeof s && (s = $.jgrid.parse(s)),
                            a(s);
                            else try {
                ...
                U = function(a, b) {
                    ...
                    u = function(a, b) {
                        ...
                        "stop" === c ? !1 : (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], T(!1)), d.p.savedRow = [], !0)
                    };
                    if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                        ...
                        1 === v.length && (v[1] = v[0]),
                        t += '<option role="option" value="' + v[0] + '"' + (z(d.p.rowNum, 0) === z(v[0], 0) ? ' selected="selected"': "") + ">" + v[1] + "</option>";
                        t += "</select></td>"
                    }
                    if ("rtl" === h && (s += t), d.p.pginput === !0 && (r = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === !0) {
                        ...
                        s += "<td id='" + w[0] + "' class='" + x + "' title='" + y[0] + "'><span " + k(l, "icon_first", !1, q) + "></span></td>",
                        s += "<td id='" + w[1] + "' class='" + x + "'  title='" + y[1] + "'><span " + k(l, "icon_prev", !1, q) + "></span></td>",
                        s += "" !== r ? p + r + p: "",
                        s += "<td id='" + w[2] + "' class='" + x + "' title='" + y[2] + "'><span " + k(l, "icon_next", !1, q) + "></span></td>",
                        s += "<td id='" + w[3] + "' class='" + x + "' title='" + y[3] + "'><span " + k(l, "icon_end", !1, q) + "></span></td>"
                    } else "" !== r && (s += r);
                    "ltr" === h && (s += t),
                    s += "</tr></tbody></table>",
                    ...
                    function() {
                        ...
                        u(this.id.split("_")[0], this) ? (this.id === "first" + b && f && (d.p.page = 1, e = !0), this.id === "prev" + b && g && (d.p.page = a - 1, e = !0), this.id === "next" + b && h && (d.p.page = a + 1, e = !0), this.id === "last" + b && i && (d.p.page = c, e = !0), e && S(), !1) : !1
                    })),
                ...
                V = function(a, b) {
                    ...
                    var h = t.indexOf(c); - 1 === h ? (t.push(c), u.push(g)) : g ? u[h] = g: (u.splice(h, 1), t.splice(h, 1)),
                    d.p.sortorder = "",
                    d.p.sortname = "";
                    for (var i = 0,
                    j = t.length; j > i; i++) i > 0 && (d.p.sortname += ", "),
                    d.p.sortname += t[i],
                    i !== j - 1 && (d.p.sortname += " " + u[i]);
                    d.p.sortorder = u[j - 1]
                },
                W = function(a, b, c, e, f) {
                    if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                        if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc": "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) V(b, f);
                        else {
                            if (e) {
                ...
                X = function() {
                    ...
                    function() {
                        ...
                        this.widthOrg = b = z(this.width, 0),
                ...
                aa = function(a, b, c) {
                    ...
                    for (e = 0; h > e; e++) {
                        ...
                        m = g[e].name,
                        n = d.p.colNames[e];
                        f = "cb" === m || "subgrid" === m || "rn" === m || g[e].hidedlg ? "style='display:none'": "",
                    ...
                    k += "</ul>",
                    $(c).append(k),
                    $("#col_menu").addClass("ui-menu " + r.menu_widget),
                ...
                ba = function(a, b, c, e) {
                    ...
                    if (k) {
                        f = d.p.colFilters && d.p.colFilters[k.name] ? d.p.colFilters[k.name] : !1,
                        f && !$.isEmptyObject(f) && (l = f.oper1, m = f.value1, n = f.rule, p = f.oper2, q = f.value2),
                        k.searchoptions || (k.searchoptions = {}),
                        g = k.searchoptions.sopt ? k.searchoptions.sopt: "text" === k.sorttype ? u: t,
                        h = k.searchoptions.operands ? k.searchoptions.operands: v.groupOps,
                        j = $("<form></form>");
                        var x = "<div>" + $.jgrid.getRegional(d, "colmenu.searchTitle") + "</div>";
                        x += '<div><select id="oper1" class="' + r.filter_select + '">',
                        $.each(v.odata,
                        function(a, b) {
                            i = b.oper === l ? 'selected="selected"': "",
                            -1 !== $.inArray(b.oper, g) && (s += '<option value="' + b.oper + '" ' + i + ">" + b.text + "</option>")
                        }),
                        x += s,
                        x += "</select></div>",
                        j.append(x);
                        var y = "";
                        k.searchoptions.defaultValue && (y = $.isFunction(k.searchoptions.defaultValue) ? k.searchoptions.defaultValue.call(d) : k.searchoptions.defaultValue),
                        m && (y = m);
                        ...
                        A = $.jgrid.createEl.call(d, k.stype, z, y, !1, $.extend({},
                        $.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {}));
                        $(A).addClass(r.filter_input),
                        x = $("<div></div>").append(A),
                        j.append(x),
                        x = '<div><select id="operand" class="' + r.filter_select + '">',
                        $.each(h,
                        function(a, b) {
                        ...
                        $.each(v.odata,
                        function(a, b) {
                            i = b.oper === p ? 'selected="selected"': "",
                            -1 !== $.inArray(b.oper, g) && (s += '<option value="' + b.oper + '" ' + i + ">" + b.text + "</option>")
                        }),
                        x = '<div><select id="oper2" class="' + r.filter_select + '">' + s + "</select></div>",
                        j.append(x),
                        y = q ? q: "",
                        ...
                        $(e).append(j),
                        $("#search_menu").addClass("ui-menu " + r.menu_widget),
                ...
                ca = function() {
                    ...
                    c = 0;
                    for (var e in d.p.colFilters) if (d.p.colFilters.hasOwnProperty(e)) {
                ...
                da = function(a, b) {
                    ...
                    e = d.p.groupingView; - 1 !== b ? e.groupField.splice(b, 1) : e.groupField.push(c.name),
                    $(d).jqGrid("groupingGroupBy", e.groupField),
                    d.p.frozenColumns && ($(d).jqGrid("destroyFrozenColumns"), $(d).jqGrid("setFrozenColumns"))
                },
                ea = function(a, b) {
                    var c, e = [],
                    ...
                    g = -1,
                    h = d.p.colModel;
                    for (c = 0; f > c; c++) h[c].frozen && (g = c),
                    e.push(c);
                    e.splice(a, 1),
                    e.splice(g + (b ? 1 : 0), 0, a),
                    h[a].frozen = b,
                    $(d).jqGrid("destroyFrozenColumns"),
                    $(d).jqGrid("remapColumns", e, !0),
                    $(d).jqGrid("setFrozenColumns")
                },
                fa = function(a, b, c) {
                    b = parseInt(b, 10),
                    c = parseInt(c, 10) + 25;
                    ...
                    j.sorting && (h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_sort_asc + '"></span></td><td class="menu_text">' + k.sortasc + "</td></tr></table></a></li>", h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_sort_desc + '"></span></td><td class="menu_text">' + k.sortdesc + "</td></tr></table></a></li>"),
                    j.columns && (h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="columns"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_columns + '"></span></td><td class="menu_text">' + k.columns + "</td></tr></table></a></li>"),
                    j.filtering && (h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="filtering"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_filter + '"></span></td><td class="menu_text">' + k.filter + " " + (i.label || i.name) + "</td></tr></table></a></li>"),
                    j.grouping && (e = $.inArray(i.name, d.p.groupingView.groupField), h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="grouping"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_group + '"></span></td><td class="menu_text">' + ( - 1 !== e ? k.ungrouping: k.grouping + " " + (i.label || i.name)) + "</td></tr></table></a></li>"),
                    j.freeze && (f = i.frozen && d.p.frozenColumns ? !1 : !0, h += '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="freeze"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_freeze + '"></span></td><td class="menu_text">' + (f ? k.freeze + " " + (i.label || i.name) : k.unfreeze) + "</td></tr></table></a></li>"),
                    h += "</ul>",
                    $("body").append(h),
                    $("#column_menu").addClass("ui-menu " + r.menu_widget),
                    $("#column_menu > li > a").hover(function() {
                        if ($("#col_menu").remove(), $("#search_menu").remove(), "columns" === $(this).attr("value")) {
                            var b = $(this).parent().width() + 18,
                            c = $(this).parent().offset().top - 40;
                            aa(c, b, $(this).parent())
                        }
                    ...
                    function() {
                        ...
                        "sortasc" === b ? W("jqgh_" + d.p.id + "_" + i.name, a, !0, "asc", c) : "sortdesc" === b ? W("jqgh_" + d.p.id + "_" + i.name, a, !0, "desc", c) : "grouping" === b ? da(a, e) : "freeze" === b && ea(a, f),
                        ( - 1 !== b.indexOf("sort") || "grouping" === b || "freeze" === b) && $(this).remove()
                    })
                };
                for (d.p.colMenu && $("body").on("click",
                function(a) {
                    $(a.target).closest(".column-menu").length || $("#column_menu").remove()
                }), this.p.id = this.id, -1 === $.inArray(d.p.multikey, y) && (d.p.multikey = !1), d.p.keyName = !1, i = 0; i < d.p.colModel.length; i++) x = "string" == typeof d.p.colModel[i].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[d.p.colModel[i].template] ? $.jgrid.cmTemplate[d.p.colModel[i].template] : {}: d.p.colModel[i].template,
                ...
                if ("horizontal" === d.p.viewsortcols[1] ? (ta = " ui-i-asc", ua = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (ta = " ui-single-sort-asc", ua = " ui-single-sort-desc", sa = " style='display:none'", d.p.viewsortcols[0] = !1), ia = s ? "class='ui-th-div-ie'": "", pa = "<span class='s-ico' style='display:none'>", pa += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + ta + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", !0) + "'" + sa + "></span>", pa += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + ua + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", !0) + "'" + sa + "></span></span>", d.p.multiSort && d.p.sortname) for (t = d.p.sortname.split(","), i = 0; i < t.length; i++) v = $.trim(t[i]).split(" "),
                t[i] = $.trim(v[0]),
                u[i] = v[1] ? $.trim(v[1]) : d.p.sortorder || "asc";
                for (i = 0; i < this.p.colNames.length; i++) {
                    var va = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[i]) + '"': "";
                    qa = d.p.colModel[i],
                    qa.hasOwnProperty("colmenu") || (qa.colmenu = "rn" === qa.name || "cb" === qa.name || "subgrid" === qa.name ? !1 : !0),
                    ra += "<th id='" + d.p.id + "_" + qa.name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + va + ">",
                    ja = qa.index || qa.name,
                    ra += "<div class='ui-th-div' id='jqgh_" + d.p.id + "_" + qa.name + "' " + ia + ">" + d.p.colNames[i],
                    qa.width ? qa.width = parseInt(qa.width, 10) : qa.width = 150,
                    "boolean" != typeof qa.title && (qa.title = !0),
                    qa.lso = "",
                    ja === d.p.sortname && (d.p.lastsort = i),
                    d.p.multiSort && (v = $.inArray(ja, t), -1 !== v && (qa.lso = u[v])),
                    ra += pa,
                    d.p.colMenu && qa.colmenu && (ra += "<a class='colmenu' href='#'><span class='colmenuspan " + q + " " + r.icon_menu + "'></span></a>"),
                    ra += "</div></th>"
                }
                ...
                function() {
                    ...
                    function() {
                        ...
                        }), d.p.selrow = null, wa = !1),
                        $(d).triggerHandler("jqGridSelectAll", [wa ? d.p.selarrrow: xa, wa]),
                ...
                X(),
                $(w).css("width", e.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"),
                d.p.scrollPopUp && $(w).append("<div " + k(l, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + d.p.id + "'></div>"),
                $(j).css("width", e.width + "px"),
                ra = $("thead:first", d).get(0);
                var za = "";
                ...
                if (d.p.disableClick = !1, $("th", Aa).each(function(a) {
                    qa = d.p.colModel[a],
                    ka = qa.width,
                    void 0 === qa.resizable && (qa.resizable = !0),
                    qa.resizable ? (la = document.createElement("span"), $(la).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : la = "",
                    $(this).css("width", ka + "px").prepend(la),
                    la = null;
                    var b = "";
                    qa.hidden && ($(this).css("display", "none"), b = "display:none;"),
                    Ba += "<td role='gridcell' style='height:0px;width:" + ka + "px;" + b + "'></td>",
                    e.headers[a] = {
                        width: ka,
                        el: this
                    },
                    sa = qa.sortable,
                    "boolean" != typeof sa && (qa.sortable = !0, sa = !0);
                    var c = qa.name;
                    "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"),
                    sa && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), d.p.colModel[a].lso && $("div span.ui-icon-" + qa.lso, this).removeClass(m).css("display", "")) : d.p.colModel[a].lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + qa.lso, this).removeClass(m).css("display", "")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === d.p.lastsort && $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", "")) : a === d.p.lastsort && "" !== d.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", ""))),
                    d.p.footerrow && (za += "<td role='gridcell' " + A(a, 0, "", null, "", !1) + ">&#160;</td>")
                }).mousedown(function(a) {
                    if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
                        var b = _(this);
                        return d.p.forceFit === !0 && (d.p.nv = Y(b)),
                        e.dragStart(b, a, Z(b)),
                        !1
                    }
                }).click(function(a) {
                    ...
                    if (1 === f.length) {
                        ...
                        null != g && W($("div", this)[0].id, g, b, c, this),
                        !1
                    }
                }), qa = null, d.p.sortable && $.fn.sortable) try {
                    $(d).jqGrid("sortableColumns", Aa)
                } catch(Ca) {}
                d.p.footerrow && (za += "</tr></tbody></table>"),
                Ba += "</tr>",
                oa = document.createElement("tbody"),
                this.appendChild(oa),
                $(this).addClass(k(l, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Ba),
                Ba = null;
                ...
                d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
                    width: e.width + "px"
                }).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(w), Ea && $(d.p.pager).hide(), U(d.p.pager, "")),
                d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover",
                function(a) {
                    na = $(a.target).closest("tr.jqgrow"),
                    "ui-subgrid" !== $(na).attr("class") && $(na).addClass(o)
                }).bind("mouseout",
                function(a) {
                    na = $(a.target).closest("tr.jqgrow"),
                    $(na).removeClass(o)
                ...
                $(d).before(e.hDiv).click(function(a) {
                    ...
                    var b = $(ma).hasClass("cbox"),
                    c = $(d).triggerHandler("jqGridBeforeSelectRow", [na[0].id, a]);
                    if (c = c === !1 || "stop" === c ? !1 : !0, $.isFunction(d.p.beforeSelectRow)) {
                        var e = d.p.beforeSelectRow.call(d, na[0].id, a); (e === !1 || "stop" === e) && (c = !1)
                    }
                    if ("A" !== ma.tagName && ("INPUT" !== ma.tagName && "TEXTAREA" !== ma.tagName && "OPTION" !== ma.tagName && "SELECT" !== ma.tagName || b)) if (Ga = na[0].id, ma = $(ma).closest("tr.jqgrow>td"), ma.length > 0 && (Ha = $.jgrid.getCellIndex(ma), Ia = $(ma).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [Ga, Ha, Ia, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, Ga, Ha, Ia, a)), d.p.cellEdit !== !0) {
                        if (c) if (d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", Ga, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ga).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ga)[d.p.useProp ? "prop": "attr"]("checked", !b));
                        else if (d.p.multiselect && d.p.multiboxonly) if (b) $(d).jqGrid("setSelection", Ga, !0, a);
                        else {
                        ...
                        } else $(d).jqGrid("setSelection", Ga, !0, a)
                    } else if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", Ga, !0, a);
                ...
                function(a, b) {
                    ...
                    b.current && d.grid.selectionPreserver(d), "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"), d.p.data.length && (J(), K())) : d.p.treeGrid || (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], T(!1)), d.p.savedRow = []), d.p.scroll && I.call(d, !0, !1), b.page) {
                        var c = b.page;
                    ...
                    if (ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
                        Ga = na[0].rowIndex,
                        Ha = $.jgrid.getCellIndex(ma);
                        var b = $(d).triggerHandler("jqGridDblClickRow", [$(na).attr("id"), Ga, Ha, a]);
                        return null != b ? b: $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(na).attr("id"), Ga, Ha, a), null != b) ? b: void 0
                    }
                }).bind("contextmenu",
                function(a) {
                    if (ma = a.target, na = $(ma, d.rows).closest("tr.jqgrow"), 0 !== $(na).length) {
                        d.p.multiselect || $(d).jqGrid("setSelection", na[0].id, !0, a),
                        Ga = na[0].rowIndex,
                        Ha = $.jgrid.getCellIndex(ma);
                        var b = $(d).triggerHandler("jqGridRightClickRow", [$(na).attr("id"), Ga, Ha, a]);
                        return null != b ? b: $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(na).attr("id"), Ga, Ha, a), null != b) ? b: void 0
                    }
                }),
                e.bDiv = document.createElement("div"),
                s && "auto" === String(d.p.height).toLowerCase() && (d.p.height = "100%"),
                ...
                Ea && $(e.bDiv).hide();
                var Ja = q + " " + k(l, "icon_caption_open", !0),
                Ka = q + " " + k(l, "icon_caption_close", !0);
                e.cDiv = document.createElement("div");
                var La = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
                    La.addClass(o)
                },
                function() {
                    La.removeClass(o)
                }).append("<span class='ui-jqgrid-headlink " + Ja + "'></span>").css("rtl" === h ? "left": "right", "0px") : "";
                if ($(e.cDiv).append(La).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl": "") + " " + k(l, "gridtitleBox", !0)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
                ...
                if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv), U(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl": "") + "'></div>"), $(e.sDiv).append(Fa).width(e.width).insertAfter(e.hDiv), $(Fa).append(za), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), Ea && $(e.sDiv).hide()), Fa = null, d.p.caption) {
                    ...
                    d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                        ...
                        function() {
                            b--,
                            0 === b && ($("span", g).removeClass(Ja).addClass(Ka), d.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).hide(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (Ea || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast",
                        function() {
                            b--,
                            0 === b && ($("span", g).removeClass(Ka).addClass(Ja), Ea && (d.p.datatype = Na, S(), Ea = !1), d.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (Ea || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }),
                        !1
                ...
                this.grid.cols = this.rows[0].cells, $(d).triggerHandler("jqGridInitGrid"), $.isFunction(d.p.onInitGrid) && d.p.onInitGrid.call(d), S(), d.p.hiddengrid = !1, d.p.responsive) {
                    var Oa = "onorientationchange" in window,
                    Pa = Oa ? "orientationchange": "resize";
                    $(window).on(Pa,
                    function() {
                        $(d).jqGrid("resizeGrid")
                    })
                ...
                if (this.grid) {
                    ...
                    if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                        ...
                        if (e >= 0 && f) {
                            ...
                            if ($(k).width(1).css("height", "100%"), $(a.grid.fhDiv).append(k).mousemove(function(b) {
            ...
            if (!this.filter) {
                ...
                this.p.filter), c) {
                    ...
                    this.createTableForGroup = function(a, b) {
                        ...
                        if (v) for (var w = 0; w < e.p.columns.length; w++) e.p.columns[w].inlist && (e.p.columns[w].search = !0);
                        if (void 0 !== a.rules) for (c = 0; c < a.rules.length; c++) if (f.append(this.createTableRowForRule(a.rules[c], a)), v) for (var x = a.rules[c].field, w = 0; w < e.p.columns.length; w++) if (x === e.p.columns[w].name) {
    ...
    $.jgrid.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    j = function() {
                        ...
                        function() {
                            ...
                            if (d = this.index || this.name, f = this.searchoptions || {},
                            e = a.searchOperators && f.searchOperMenu ? m.parent().prev().children("a").attr("soper") || a.defaultSearch: f.sopt ? f.sopt[0] : "select" === this.stype ? "eq": a.defaultSearch, b = "custom" === this.stype && $.isFunction(f.custom_value) && m.length > 0 && "SPAN" === m[0].nodeName.toUpperCase() ? f.custom_value.call(c, m.children(".customelement:first"), "get") : m.val(), "select" === this.stype && f.multiple && $.isArray(b) && b.length && (j = !0, k.push(d), b = 1 === b.length ? b[0] : b), "bt" === e && (l = !0), b || "nu" === e || "nn" === e) g[d] = b,
                            i[d] = e,
                            h++;
                            else try {
                        ...
                        if (a.stringResult === !0 || "local" === c.p.datatype || a.searchOperators === !0) {
                            ...
                            n += "]}";
                            var p, q, r, s, t, u, v;
                            if (j && (p = $.jgrid.parse(n), p.rules && p.rules.length)) for (q = p.rules, r = 0; r < q.length; r++) t = q[r],
                            $.inArray(t.filed, k) && (u = t.data.split(a.splitSelect), u.length > 1 && (void 0 === p.groups && (p.groups = []), v = {
                                groupOp: a.groupOpSelect,
                                groups: [],
                                rules: []
                            },
                            p.groups.push(v), $.each(u,
                            function(a) {
                                s = u[a],
                                s && v.rules.push({
                                    data: u[a],
                            ...
                            if (l && ($.isPlainObject(p) || (p = $.jgrid.parse(n)), p.rules && p.rules.length)) for (q = p.rules, r = 0; r < q.length; r++) t = q[r],
                            "bt" === t.op && (u = t.data.split("..."), u.length > 1 && (void 0 === p.groups && (p.groups = []), v = {
                                groupOp: "AND",
                                groups: [],
                                rules: []
                            },
                            ...
                            }), q.splice(r, 1), r--)); (l || j) && (n = JSON.stringify(p)),
                            $.extend(c.p.postData, {
                                filters: n
                            }),
                        ...
                        var x = "stop" === $(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1; ! x && $.isFunction(a.beforeSearch) && (x = a.beforeSearch.call(c)),
                        x || $(c).jqGrid("setGridParam", {
                            search: m
                        }).trigger("reloadGrid", [{
                            page: 1
                        }]),
                    ...
                    m = function(b, d, e) {
                        ...
                        function() {
                            n.push(this.oper)
                        }), o = 0; o < s.sopt.length; o++) i = $.inArray(s.sopt[o], n),
                        -1 !== i && (f = m === a.odata[i].oper ? h.highlight: "", l += '<li class="ui-menu-item ' + f + '" role="presentation"><a class="' + h.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + a.odata[i].oper + '" oper="' + a.operands[a.odata[i].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + a.operands[a.odata[i].oper] + "</td><td>" + a.odata[i].text + "</td></tr></table></a></li>");
                        l += "</ul>",
                        $("body").append(l),
                        ...
                        function() {
                            ...
                            if ($(c).triggerHandler("jqGridToolbarSelectOper", [d, e, b]), $("#sopt_menu").hide(), $(b).text(e).attr("soper", d), a.autosearch === !0) {
                                var f = $(b).parent().next().children()[0]; ($(f).val() || "nu" === d || "nn" === d) && j()
                            }
                        })
                    },
                    ...
                    function(b) {
                        ...
                        if (this.hidden === !0 && $(u).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), this.searchoptions = this.searchoptions || {},
                        void 0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), f = $.extend({},
                        this.searchoptions, {
                            name: r.index || r.name,
                    ...
                    $(".clearsearchclass", n).click(function() {
                        ...
                        f = $.extend({},
                        c.p.colModel[e].searchoptions || {}),
                        g = f.defaultValue ? f.defaultValue: "";
                        "select" === c.p.colModel[e].stype ? (b = $("td.ui-search-input select", d), g ? b.val(g) : b[0].selectedIndex = 0) : (b = $("td.ui-search-input input", d), b.val(g)),
        ...
        refreshFilterToolbar: function(a) {
            ...
            this.each(function() {
                function b(e) {
                    if (e && e.rules) {
                        for (f = e.rules, k = f.length, c = 0; k > c; c++) g = f[c],
                        h = $.inArray(g.field, l),
                        -1 !== h && (d = $("#gs_" + i.p.idPrefix + $.jgrid.jqID(j[h].name)), d.length > 0 && ("select" === j[h].stype ? d.find("option[value='" + $.jgrid.jqID(g.data) + "']").prop("selected", !0) : "text" === j[h].stype && d.val(g.data), $.isFunction(a.onSetVal) && a.onSetVal.call(i, d, j[h].name)));
                        if (e.groups) for (var m = 0; m < e.groups.length; m++) b(e.groups[m])
                    }
                }
                ...
                if (i.p.filterToolbar) {
                    ...
                    "string" == typeof a.filters && a.filters.length && (e = $.jgrid.parse(a.filters)),
                    $.isPlainObject(e) && b(e)
                }
            })
        },
                ...
                if (c.grid) {
                    ...
                    if (a += "", "local" !== !c.p.datatype) {
                        ...
                        function() {
                            ...
                            (this.search || b.searchAll) && (h > 0 && (g += ","), g += '{"field":"' + d + '",', g += '"op":"' + f + '",', g += '"data":"' + a.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', h++)
                        }),
                        g += "]}",
                        $.extend(c.p.postData, {
                            filters: g
                        ...
                        var i = "stop" === $(c).triggerHandler("jqGridFilterInputBeforeSearch") ? !0 : !1; ! i && $.isFunction(b.beforeSearch) && (i = b.beforeSearch.call(c)),
    ...
    if ($.jgrid.extend({
        editGridRow: function(a, b) {
            ...
            this.each(function() {
                ...
                function d(a, b, c, d) {
                    ...
                    if ("_empty" !== a && (o = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function(l) {
                        if (f = this.name, g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, j = g ? "style='display:none'": "", "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
                            ...
                            if ("_empty" === a && s.defaultValue && (i = $.isFunction(s.defaultValue) ? s.defaultValue.call(q) : s.defaultValue), this.edittype || (this.edittype = "text"), q.p.autoencode && (i = $.jgrid.htmlDecode(i)), k = $.jgrid.createEl.call(q, this.edittype, s, i, !1, $.extend({},
                ...
                function g(a, b, c) {
                    var d, e, f, g, h, i, j = 0; (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData = {},
                    rp_ge[q.p.id]._savedData[b.p.id + "_id"] = a);
                    var k = b.p.colModel;
                    ...
                    l && ($('td[role="gridcell"]', l).each(function(f) {
                        if (d = k[f].name, "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                            ...
                            case "checkbox":
                                ...
                                e.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== e ? ($("#" + d, c)[q.p.useProp ? "prop": "attr"]("checked", !0), $("#" + d, c)[q.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : ($("#" + d, c)[q.p.useProp ? "prop": "attr"]("checked", !1), $("#" + d, c)[q.p.useProp ? "prop": "attr"]("defaultChecked", !1)); (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (e = $("#" + d, c).is(":checked") ? $("#" + d, c).val() : $("#" + d, c).attr("offval"), rp_ge[q.p.id]._savedData[d] = e);
                                break;
                            case "custom":
                                try {
                ...
                function k() {
                    ...
                    c(), t = j(s, rp_ge[q.p.id]._savedData), t && ($(w).data("disabled", !0), $(".confirm", "#" + z.themodal).show(), a = !1)),
                    a
                }
                function l() {
                    var b;
                ...
                if (q.grid && a) {
                    ...
                    if (D ? (G = o(rp_ge[$(this)[0].p.id].template), r = y) : (G = $("<table id='" + x + "' class='EditTable ui-common-table'><tbody></tbody></table>"), r = y + "_2"), w = "#" + $.jgrid.jqID(w), $(J).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(J).append("<div class='tinfo topinfo'>" + rp_ge[q.p.id].topinfo + "</div>"), $(q.p.colModel).each(function() {
                        ...
                        if (D ? ($(J).find("#pData").replaceWith(N), $(J).find("#nData").replaceWith(O), $(J).find("#sData").replaceWith(P), $(J).find("#cData").replaceWith(Q), U = $("<div id=" + x + "></div>").append(J)) : U = $("<div></div>").append(J).append(R), $(J).append("<div class='binfo topinfo bottominfo'>" + rp_ge[q.p.id].bottominfo + "</div>"), $.jgrid.createModal(z, U, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(q.p.id), $("#gbox_" + $.jgrid.jqID(q.p.id))[0]), K && ($("#pData, #nData", y + "_2").css("float", "right"), $(".EditButton", y + "_2").css("text-align", "left")), rp_ge[q.p.id].topinfo && $(".tinfo", w).show(), rp_ge[q.p.id].bottominfo && $(".binfo", w).show(), U = null, R = null, $("#" + $.jgrid.jqID(z.themodal)).keydown(function(a) {
                            ...
                            if (rp_ge[q.p.id].savekey[0] === !0 && a.which === rp_ge[q.p.id].savekey[1] && "TEXTAREA" !== c.tagName) return $("#sData", y + "_2").trigger("click"),
                            !1;
                            ...
                            if (rp_ge[q.p.id].navkeys[0] === !0) {
                                ...
                                if (a.which === rp_ge[q.p.id].navkeys[1]) return $("#pData", r).trigger("click"),
                                !1;
                                if (a.which === rp_ge[q.p.id].navkeys[2]) return $("#nData", r).trigger("click"),
                                !1
                            }
                            ...
                            $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}), $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)), e[0] && !rp_ge[c.p.id].processing) {
                                ...
                                var k = $.extend({
                                    ...
                                    complete: function(a, g) {
                                        var h;
                                        if ($("#dData", "#" + p + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, $.isFunction(rp_ge[c.p.id].errorTextFormat) ? e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a) : e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)), e[0] === !1) $("#DelError>td", "#" + p).html(e[1]),
                                        $("#DelError", "#" + p).show();
                                        else {
        ...
        _buildNavMenu: function(a, b, c, d, e, f, g, h) {
            return this.each(function() {
                ...
                r = function() {
                    ...
                    c.add && (e = e || {},
                    a = e.id || "add_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.addtext || c.addtitle) + "</a></li>").click(function() {
                        return $(this).hasClass(m.disabled) || ($.isFunction(c.addfunc) ? c.addfunc.call(i) : $(i).jqGrid("editGridRow", "new", e), $(o).hide()),
                        !1
                    }), $(o).append(j)),
                    c.edit && (d = d || {},
                    a = d.id || "edit_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.edittext || c.edittitle) + "</a></li>").click(function() {
                    ...
                    c.view && (h = h || {},
                    a = h.id || "view_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.viewtext || c.viewtitle) + "</a></li>").click(function() {
                        if (!$(this).hasClass(m.disabled)) {
                            var a = i.p.selrow;
                    ...
                    c.del && (f = f || {},
                    a = f.id || "del_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.deltext || c.deltitle) + "</a></li>").click(function() {
                        if (!$(this).hasClass(m.disabled)) {
                            var a;
                    ...
                    c.search && (g = g || {},
                    a = g.id || "search_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.searchtext || c.searchtitle) + "</a></li>").click(function() {
                ...
                r(),
                $(".dropdownmenu", a + "_" + c.position).on("click",
                function(a) {
                    var b = $(this).offset(),
                    c = b.left,
                    d = parseInt(b.top),
                ...
                if (this.grid) {
                    ...
                    if ("remote" === a.exptype) {
                        ...
                        if (a.exporthidden) {
                            ...
                            h = g.length,
                            i = [];
                            for (f = 0; h > f; f++) void 0 === g[f].hidden && (g[f].hidden = !1),
                            i.push({
                                name: g[f].name,
                                hidden: g[f].hidden
                            });
        ...
        jqPivot: function(a, b, c, d) {
            return this.each(function() {
                function e(a) {
                    ...
                    for (b.ignoreCase && (k = k.ignoreCase()), d = 0; d < i.groupOptions.groupingView.groupField.length; d++) e = b.xDimension[d].sortorder ? b.xDimension[d].sortorder: "asc",
                ...
                if (c.grid) {
                    ...
                    for (void 0 !== b && b > 0 && (r = b, q = b + 1); q > r;) {
                        if ($(c.rows[r]).hasClass("jqgrow")) {
                            ...
                            p === !1 ? c.rows[r].cells[a].innerHTML = "": $(c.rows[r].cells[a]).bind("click",
                            function() {
    ...
    $.jgrid.extend({
        ...
        getRootNodes: function(a) {
            ...
            return this.each(function() {
                ...
                case "adjacency":
                    ...
                    $(e).each(function() { (null === this[d] || "null" === String(this[d]).toLowerCase()) && (a ? b.push(f.p.data[f.p._index[this[f.p.keyName]]]) : b.push(this))
                    })
                }
            }),
            b
            ...
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid) {
                    ...
                    case "nested":
                        ...
                        l = parseInt(a[i], 10),
                        m = parseInt(a[j], 10);
                        for (e = 0; g > e; e++) f = b ? d.p.data[d.p._index[this.rows[e].id]] : d.p.data[e],
                        f && parseInt(f[j], 10) === m + 1 && parseInt(f[h], 10) > k && parseInt(f[i], 10) < l && c.push(f);
                        break;
                    case "adjacency":
                        var n = d.p.treeReader.parent_id_field,
                        o = d.p.localReader.id;
                        for (e = 0; g > e; e++) f = b ? d.p.data[d.p._index[this.rows[e].id]] : d.p.data[e],
                        f && String(f[n]) === $.jgrid.stripPref(d.p.idPrefix, a[o]) && c.push(f)
                    }
                }
            }),
            c
        ...
        searchTree: function(a) {
            ...
            k = [];
            return this.each(function() {
                if (this.grid && this.p.treeGrid && h) for (b = this.p.localReader.id; h--;) if (i = $(this).jqGrid("getNodeAncestors", a[h], !0, !0), i.push(a[h]), c = i[0][b], -1 === $.inArray(c, j)) j.push(c),
                k = k.concat(i);
                else for (f = 0, d = i.length; d > f; f++) {
                    var l = !1;
                    for (g = 0, e = k.length; e > g; g++) if (i[f][b] === k[g][b]) {
                        l = !0;
                        break
                    }
                    l || k.push(i[f])
        ...
        collectChildrenSortTree: function(a, b, c, d, e, f) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var g, h, i, j, k, l;
                    for (j = $(this).jqGrid("getNodeChildren", b, this.p.search), k = $.jgrid.from.call(this, j), k.orderBy(c, d, e, f), l = k.select(), g = 0, h = l.length; h > g; g++) i = l[g],
                    a.push(i),
    ...
    $.fn.html5sortable = function(a) {
        ...
        this.each(function() {
            ...
            c.attr("draggable", "true").on("dragstart.h5s",
            function(b) {
            ...
            function() {
                ...
                !1
            }).end().add([this, f]).on("dragover.h5s dragenter.h5s drop.h5s",
            function(b) {
